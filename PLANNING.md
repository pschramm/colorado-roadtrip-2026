...
| Sun/Mon 30/31 – Wed 2 | Durango, extended stay | booked directly by user (Aug 29) — hotel/confirmation not logged here yet |
...
- **Durango lodging gap — resolved Aug 29.** User booked directly rather than through the usual email/calendar trail, so the actual hotel name and confirmation details aren't in this guide. Get those next time there's a spare minute and log them properly.
- **El Rey Court, Santa Fe — not booked.** Two nights (Thu–Sat checkout) needed before departure from Durango. Address and dog policy (1 dog any size, or 2 up to 70lbs, $50/stay) confirmed via BringFido; nothing reserved.
- **Departure day loosened to "Wednesday or Thursday."** As of Aug 29, user said Wed or Thu, not firmly Thursday as the guide currently assumes. El Rey Court is planned Thu–Sat (2 nights); if departure ends up being Wednesday, that's an extra unplanned night somewhere before Santa Fe. Not restructured in the guide yet — Thursday stays the working assumption until it's pinned down.
