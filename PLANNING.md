...
*Last updated Sep 1 (mid-trip, based in Durango). This is the one block worth reading on the road — everything below is the reasoning archive, not the status.*
...
| Sun 30 – Tue 1 | La Quinta, Durango again (125 Mercury Village Dr) | confirmed, #88884EE060328, 3 nights |
| Wed 2 | La Quinta, Albuquerque Midtown (2011 Menaul Blvd NE) | confirmed, #88920EE079720, booked Sep 1, checkout date unclear — see open items |
...
| Sat 5 | La Quinta, Abilene Mall (3018 Catclaw Dr) | **not booked** — the plan, not a reservation |
...
- **La Quinta Albuquerque checkout date has the same discrepancy — third booking in a row now.** Confirmation email (#88920EE079720, received Sep 1) says "1 Room(s) / 1 Night(s)," checkout Thursday Sep 3. The calendar event spans Sep 2 → Sep 4 (2 nights). At this point it looks like Google's calendar-from-email parser has a systematic off-by-one on Wyndham confirmation emails specifically — worth just trusting the email every time rather than re-litigating it per booking.
...
- **Resolved Sep 1: what happens after Santa Fe.** User's answer — Saturday to Abilene (not Lubbock, past it toward Austin, splitting a 687-mile direct push so Sunday stays short), Sunday home to Austin 78723. The Sept 5 "Flight to Raleigh/Durham" departing Austin that's been on the calendar since before this trip started appears unrelated to this return — the user's direct instructions don't reference it, and departing Austin the same morning they'd still be en route wouldn't work anyway. Not raised as a conflict; treating the explicit instruction as authoritative over old calendar noise, consistent with the standing "calendar isn't always the last word" lesson.
- **Abilene lodging not booked.** La Quinta Abilene Mall (3018 Catclaw Dr) is the pick — dog policy confirmed via Wyndham's own site (2 pets, 75lbs each, $25/night fee, $75/stay cap), though BringFido conflictingly lists it as not pet-friendly. Worth a direct call before counting on it, and worth actually booking before Saturday — a 482-mile day is a bad one to arrive at without a room waiting.
...
- **Sep 1** — The trip finally has a real ending: home is Austin, TX 78723. User wants two days, not one 687-mile push, and specifically past Lubbock rather than stopping there. Added Saturday (Santa Fe → Abilene, 482mi/7h36 — the longest single day of the trip, deliberately, so Sunday stays light) and Sunday (Abilene → Austin, 215mi/3h34, trip odometer closes out). Found a real La Quinta in Abilene (Mall location, 3018 Catclaw Dr) with a genuine pet-policy discrepancy between Wyndham's own site and BringFido — flagged rather than picked silently, matching the pattern for every ambiguous source this trip. Not booked yet. Mileage 1,107 → 1,804. Also added real local breakfast/lunch/coffee picks for the Albuquerque day per a separate request: Frontier Restaurant (UNM-area institution since 1971), Duran Central Pharmacy (a working pharmacy + New Mexican lunch counter since the 1960s), Tia B's La Waffleria (dog-friendly brunch). Noted that the old "Flight to Raleigh/Durham" calendar entry departing Austin Sep 5 looks unrelated to this return leg and is being disregarded — the user's direct Saturday/Sunday instructions are treated as authoritative.

- **Sep 1** — Added a new Wednesday leg: user booked a night in Albuquerque (La Quinta Midtown, 2011 Menaul Blvd NE), resolving the open "Wednesday gap" between Durango checkout and Santa Fe check-in that's been flagged since Aug 31. Split the old combined Sun–Wed Durango section into Sun–Tue (`#durangoext`) and a new Wed `#abq` section, and rewrote Thursday's drive from "Durango → Santa Fe, 212mi/3h57" to "Albuquerque → Santa Fe, 54mi/53min" — removed Rio Chama Espresso, Cafe Abiquiu, and Echo Amphitheater from that day since none are on the new route anymore (they were real for the old US-84 route, not fabricated, just no longer applicable). Added real ABQ content: La Cumbre Brewing Co (1.2mi, dog patio), Nob Hill/Roosevelt Park for photos (Route 66 murals and neon, off-leash park), and tonight's actual small-venue live music lineup (Shane Wallin, Fervence, Kazha — none major, said so plainly). Same email-vs-calendar checkout discrepancy showed up a third time on the ABQ booking; noted in "Right now" that this now looks systematic to Wyndham confirmation emails rather than a one-off. Mileage 1,054 → 1,107 (211mi Durango→ABQ + 54mi ABQ→Santa Fe replacing the old 212mi direct leg). Updated the Leaflet map's stop array and nav to match.
